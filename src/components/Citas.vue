...
@media (max-width: 950px) {
  .booking-layout {
    grid-template-columns: 1fr; /* Pasa el formulario debajo de la tarjeta del mecánico */
  }
...
@media (max-width: 680px) {
  ...
  /* Apilamos la foto y la info principal si la pantalla es muy pequeña */
  .mechanic-card-top {
    flex-direction: column;
    align-items: flex-start;
    text-align: left;
  ...
  /* Forzamos a que el calendario mantenga sus flechas a los lados */
  .calendar-header {
    flex-direction: row; 
    justify-content: space-between;
    align-items: center;
  ...
  .calendar-grid span {
    height: 36px;
    font-size: 0.85rem; /* Ajustamos los números para que no se salgan de sus círculos */
  }

  /* Hacemos que los botones ocupen todo el ancho para picarlos fácil con el dedo */
  .booking-actions {
    flex-direction: column;
  }
